...
//ADDED RINGMETER AND DHT AS A PROJECT DBEVAN 15/12/2015
//#define DEBUG
#include <SPI.h>
#include "DHT.h"
...
void setup(void) {
 ...
 // tft.fillScreen(ILI9341_GREY);
  ...
  tft.setTextColor(ILI9341_WHITE, ILI9341_BLACK);  // Adding a background colour erases previous text automatically
  ...
  tft.drawCentreString("Time Fly's",120,200,2);
...
void loop() {
 ...
 // if (targetTime < millis()) {
    //targetTime = millis()+870;//adjustable have used 790 lower=faster
