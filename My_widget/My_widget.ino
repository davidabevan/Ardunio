...
extern unsigned int wifi[0x400];
#if defined(ST7735)
...
//const String THINGSPEAK_CHANNEL_ID = "67333";//Stenalees
//const String THINGSPEAK_API_READ_KEY = "EDEHCB56GI6ZT2LN";//Stenalees
...
void setup() {
  ...
  int counter = 0;
    ...
    tft.println("Connecting to WiFi");
     ...
     counter++;
//     tft.drawBitmap ;
// tft.drawBitmap (105, 80, 60, 36, wifi);
    }
 tft.println("");
